        ...
        <div ref={containerRef} className="min-h-screen">
            ...
            <section className="px-4 mt-5 md:mt-20">
                <div className="flex items-center justify-center gap-4">
                    <Asterisk ref={starLeftRef} strokeWidth={1} className="h-10 w-10 md:h-28 md:w-28 text-ink md:ml-5" style={{ rotate: "45deg" }} />
                    <h1 ref={titleRef} className="font-script text-4xl md:text-[10rem] text-gray-900 whitespace-nowrap">
                        {project.title}
                    </h1>
                    <Asterisk ref={starRightRef} strokeWidth={1} className="h-10 w-10 md:h-28 md:w-28 text-ink md:ml-5" style={{ rotate: "45deg" }} />
                </div>

                <div className="text-center mt-5 md:mt-24">
                    <p ref={descriptionRef} className="text-xl md:text-5xl font-bold text-ink uppercase max-w-[70vw] mx-auto">
                ...
                <div ref={tagsRef} className="mt-2 overflow-hidden w-[60vw] md:w-[20vw] mx-auto">
                    <div className="flex animate-scroll gap-8 md:gap-12 items-center justify-start">
                        {[...project.tags, ...project.tags, ...project.tags].map((tag, index) => (
                            <span key={index} className="text-xs md:text-sm text-ink uppercase tracking-wider whitespace-nowrap">
                                {tag}
                            </span>
                        ))}
                    </div>
            ...
            <div ref={separatorRef} className="mt-20 md:mt-32 border-t-2 border-ink mb-20"></div>
