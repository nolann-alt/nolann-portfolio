...
const PageEndSection = forwardRef<HTMLElement, PageEndSectionProps>(function PageEndSection(
    { title, ctaLabel, ctaHref = "mailto:nolann.lescop@outlook.com" },
    ref
) {
    // Si aucune prop n'est passée, on utilise les traductions de la langue courante
    const lang = useLang();
    const t = getDictionary(lang);
    const resolvedTitle = title ?? t.shared.pageEndTitle;
    const resolvedCtaLabel = ctaLabel ?? t.shared.pageEndCta;
